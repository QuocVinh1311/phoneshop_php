<?php 
    ...
    if(isset($_POST['btn_edit_product_edit'])){
        if(isset($_POST['name_product_edit']) && isset($_POST['price_product_edit']) && isset($_POST['kind_product_edit'])  && isset($_POST['quantity_product_edit']) && isset($_POST['des_product_edit']) && isset($_POST['ram_product_edit']) && isset($_POST['rom_product_edit']) && isset($_POST['pin_product_edit']) && isset($_POST['color_product_edit']) && isset($_POST['screen_product_edit'])  && isset($_POST['hdh_product_edit']) && isset($_FILES['img_of_product'])){
            $name_product_edit=$_POST['name_product_edit'];
            $price_product_edit=$_POST['price_product_edit'];
            $kind_product_edit=$_POST['kind_product_edit'];
            $quantity_product_edit=$_POST['quantity_product_edit'];
            $des_product_edit=$_POST['des_product_edit'];
            $ram_product_edit = $_POST['ram_product_edit'];
            $rom_product_edit = $_POST['rom_product_edit'];
            $pin_product_edit = $_POST['pin_product_edit'];
            $color_product_edit=$_POST['color_product_edit'];
            $screen_product_edit=$_POST['screen_product_edit'];
            $hdh_product_edit=$_POST['hdh_product_edit'];
            $img_of_product=$_FILES['img_of_product'];
            
            //Nếu không có thay đổi hình ảnh
            if(empty($img_of_product['name'])){
                update_data_product($name_product_edit,$price_product_edit,$kind_product_edit,$des_product_edit,$quantity_product_edit,$ram_product_edit,$rom_product_edit,$pin_product_edit,$color_product_edit,$screen_product_edit,$hdh_product_edit,$id_of_product);
                ...
                if($check_status_upload_img_edit=='success'){
                    ...
                    $sql_img="update product set pic=? where id_p=?";
        ...
        <div class="row">
            <form action="?id_of_product=<?php if(isset($_GET['id_of_product'])){ echo $_GET['id_of_product'];}?>" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" name="name_product_edit" class="form-control" id="name_product_edit" value="<?php echo $data_of_the_product_to_be_edited['name_p'];?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="kind_product_edit" class="form-label">Loại sản phẩm</label>
                    <select class="form-select" id="kind_product_edit" name="kind_product_edit" required>
                        <?php 
                ...
                <div class="mb-3">
                    <label for="quantity_product_edit" class="form-label">Tồn kho</label>
                    <input type="text" name="quantity_product_edit" class="form-control" id="quantity_product_edit" value="<?php echo $data_of_the_product_to_be_edited['quantity'];?>" required>
                </div>
                <div class="mb-3">
                    <label for="ram_product_edit" class="form-label">Ram</label>
                    <input type="text" name="ram_product_edit" class="form-control" id="ram_product_edit" value="<?php echo $data_of_the_product_to_be_edited['ram'];?>" required>
                </div>
                <div class="mb-3">
                    <label for="rom_product_edit" class="form-label">Rom</label>
                    <input type="text" name="rom_product_edit" class="form-control" id="rom_product_edit" value="<?php echo $data_of_the_product_to_be_edited['rom'];?>" required>
                </div>
                <div class="mb-3">
                    <label for="pin_product_edit" class="form-label">Pin</label>
                    <input type="text" name="pin_product_edit" class="form-control" id="pin_product_edit" value="<?php echo $data_of_the_product_to_be_edited['pin'];?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="screen_product_edit" class="form-label">Màn hình:</label>
                    <input type="text" name="screen_product_edit" class="form-control" id="screen_product_edit" required value="<?php echo $data_of_the_product_to_be_edited['color'];?>">
                </div>
                
                <div class="mb-3">
                    <label for="hdh_product_edit" class="form-label">Hệ điều hành:</label>
                    <input type="text" name="hdh_product_edit" class="form-control" id="hdh_product_edit" required value="<?php echo $data_of_the_product_to_be_edited['hdh'];?>">
                </div>
                <div class="mb-3">
                    <p>Ảnh minh họa sản phẩm hiện tại:</p>
                    <img src="upload/<?php echo $data_of_the_product_to_be_edited['pic'];?>" width="200px" height="200px" class="img-thumbnail" alt="">
                </div>
                <div class="mb-3">
