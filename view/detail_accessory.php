...
<h1 style="text-align:center; margin-top: 250px;">Chi tiết sản phẩm</h1>

    <div class="row">
        <div class="col-md-6 mb-3">
            <img id="img_detail_product" src="<?php echo "../admin/upload/".$detail_of_accessory['pic'];?>" alt="">
        </div>
        <div id="contain_detail_product" class="col-md-6 mb-3">
            <h2 id="name_of_detail_product"><?php echo $detail_of_accessory['name'];?></h2>
            <i class="far fa-clock"></i>
            <hr>
            <p id="price_of_detail_product" class="text-center"><span><?php echo number_format($detail_of_accessory['price'],0,",",".")."đ";?></span></p>
           
            <?php if ($detail_of_accessory['quantity']>0) {?>
            <div class="product-quantity"><lable></lable>Tồn kho:  <p><?php echo $detail_of_accessory['quantity'];?></p></div>
            <form id="form_add_into_cart" method="post" class="row mt-5" action="?action=cart">
                ...
                <input type="hidden" name="id_of_product" value="<?php echo $detail_of_accessory['id'];?>">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo $detail_of_accessory['name'];?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p><?php echo $detail_of_accessory['des'];?></p>
                </div>
